...
public final class FragmentFavoritesBinding implements ViewBinding {
  ...
  private FragmentFavoritesBinding(@NonNull LinearLayout rootView, @NonNull ProgressBar progressBar,
  ...
  public static FragmentFavoritesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFavoritesBinding((LinearLayout) rootView, progressBar, recyclerView,
