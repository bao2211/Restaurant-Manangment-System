...
public final class ItemCartBinding implements ViewBinding {
  ...
  private ItemCartBinding(@NonNull CardView rootView, @NonNull ImageView btnDecrease,
      @NonNull ImageView btnIncrease, @NonNull ImageView btnRemove, @NonNull ImageView ivFoodImage,
      @NonNull TextView tvFoodName, @NonNull TextView tvPrice, @NonNull TextView tvQuantity) {
  ...
  public static ItemCartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCartBinding((CardView) rootView, btnDecrease, btnIncrease, btnRemove,
          ivFoodImage, tvFoodName, tvPrice, tvQuantity);
    }
