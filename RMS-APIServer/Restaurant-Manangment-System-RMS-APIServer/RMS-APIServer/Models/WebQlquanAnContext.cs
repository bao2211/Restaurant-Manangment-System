...
public partial class WebQlquanAnContext : DbContext
{
    public WebQlquanAnContext()
    {
    }

    public WebQlquanAnContext(DbContextOptions<WebQlquanAnContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<TableReservationHistory> TableReservationHistories { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            optionsBuilder.UseMySql("Server=db;Database=webQLQuanAn;User=root;Password=CaoBao2211;",
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<RecipeDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.Recipe).WithMany(p => p.RecipeDetails)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Recipe_Detail_Recipe");
        });
        ...
        {
            entity.HasKey(e => e.UserFavoriteId).HasName("PK_UserFavorite");
            entity.ToTable("UserFavorites");

            entity.HasIndex(e => new { e.UserId, e.FoodId }, "IX_UserFavorites_UserId_FoodId").IsUnique();
            ...
            entity.HasOne(d => d.Food).WithMany()
                .HasForeignKey(d => d.FoodId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("FK_UserFavorites_Food");
        });
        ...
        modelBuilder.Entity<OrderHistory>(entity =>
        {
            ...
            entity.HasOne(d => d.Table).WithMany()
                .HasForeignKey(d => d.TableId)
                .HasConstraintName("FK_OrderHistory_Table");
        });

        modelBuilder.Entity<TableReservationHistory>(entity =>
        {
            entity.HasKey(e => e.ReservationHistoryId).HasName("PK_TableReservationHistory");
            entity.ToTable("TableReservationHistory");

            entity.Property(e => e.ReservationHistoryId)
                .HasMaxLength(10);
            entity.Property(e => e.UserId)
                .HasMaxLength(10);
            entity.Property(e => e.TableId)
                .HasMaxLength(10);
            entity.Property(e => e.ReservationDate).HasColumnType("datetime(6)");
            entity.Property(e => e.ReservationTime).HasColumnType("time(6)");
            entity.Property(e => e.CreatedTime).HasColumnType("datetime(6)");
            entity.Property(e => e.CancelledTime).HasColumnType("datetime(6)");
            entity.Property(e => e.Status).HasMaxLength(20);
            entity.Property(e => e.Note).HasMaxLength(200);
            ...
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("FK_TableReservationHistory_User");

            entity.HasOne(d => d.Table).WithMany()
                .HasForeignKey(d => d.TableId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("FK_TableReservationHistory_Table");
        });
