...
namespace RMS_APIServer.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        // OPTIONS: api/Order (Handle preflight requests)
        [HttpOptions]
        ...
        // POST: api/Order
        [HttpPost]
        public async Task<ActionResult<object>> PostOrder(CreateOrderDto orderDto)
        {
            ...
            // Generate a 10-character OrderId if not provided
            ...
            {
                // Ensure OrderId is exactly 10 characters (database constraint)
                order.OrderId = orderDto.OrderId.PadRight(10).Substring(0, 10);
            }
        ...
        {
            // Generate a 10-character OrderId: ORD + 7-digit timestamp-based number
            var timestamp = DateTimeOffset.UtcNow.ToUnixTimeSeconds();
            var lastSevenDigits = (timestamp % 10000000).ToString("D7");
            return "ORD" + lastSevenDigits;
        }
    }
}
